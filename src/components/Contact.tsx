        ...
        <div className="grid lg:grid-cols-2 gap-16">
          ...
          <div className="animate-fade-in-up">
            ...
            <div className="relative rounded-2xl overflow-hidden shadow-card border border-border h-48">
              <iframe
                src="https://www.google.com/maps/embed/v1/place?key=AIzaSyBFw0Qbyq9zTFTd-tUY6dZWTgaQzuU17R8&q=140+Clarendon+Street+East+Melbourne+VIC+3002+Australia&zoom=16"
                width="100%"
                height="100%"
                style={{ border: 0 }}
                allowFullScreen
