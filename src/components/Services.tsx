    ...
    <section id="services" className="py-24 lg:py-32 bg-navy-dark">
      <div className="container mx-auto px-4 md:px-8">
        ...
        <div className="animate-fade-in-up max-w-2xl mx-auto">
          ...
          <ul className="grid grid-cols-2 gap-x-8 gap-y-3 items-start">
            {otherServices.map((service) => (
              <li
                key={service}
                className="flex items-start text-primary-foreground text-base"
              >
                <ArrowRight className="w-4 h-4 text-teal mr-2 flex-shrink-0 mt-1.5" />
                {service}
              </li>
            ))}
          </ul>
