          ...
          <div className="flex flex-col md:flex-row gap-10 items-start mb-12">
            ...
            <div className="md:w-2/3">
              ...
              <div className="space-y-6 text-foreground/90 leading-relaxed">
                <p>
                  Dr Justin Chee is a highly respected urological surgeon specialising in reconstructive urology. Dr Chee's expertise include dealing with complex urethral stricture repair, Dr Justin Chee is a highly respected urological surgeon specialising in reconstructive urology. Dr Chee's expertise include dealing with complex urethral stricture repair, performing Urethroplasties since 2011, and specialises in dealing with complex cases. He is known for his innovative, collaborative, and multidisciplinary approach, focusing on achieving the best possible outcomes for his patients across Victoria., and specialises in dealing with complex cases. He is known for his innovative, collaborative, and multidisciplinary approach, focusing on achieving the best possible outcomes for his patients across Victoria.
                </p>
